...
<?php
  ...
  $users = $conn->query("SELECT name, age, superpower, description, COUNT(likes)
                          ...
                          WHERE email = 'wolverine@gmail.com'");
  ...
  foreach ($users as $user) {
    ...
    <form action="../process/like_wolverine.php" method="post">
      <input type="submit" name="like" value="LIKE">
    </form>

    <form action="../process/new_message_wolverine.php" method="post">
    ...
    <h2>Comments</h2>
      ...
      <form action="../process/new_comment_wolverine.php" method="post">
